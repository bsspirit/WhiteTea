...
--
-- Definition of table `tea`.`t_tea_user`
--

DROP TABLE IF EXISTS `tea`.`t_tea_user`;
CREATE TABLE  `tea`.`t_tea_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tea`.`t_tea_user`
--

/*!40000 ALTER TABLE `t_tea_user` DISABLE KEYS */;
LOCK TABLES `t_tea_user` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `t_tea_user` ENABLE KEYS */;
...
--
-- Definition of table `tea`.`t_tea_wiki_stat`
--

DROP TABLE IF EXISTS `tea`.`t_tea_wiki_stat`;
CREATE TABLE  `tea`.`t_tea_wiki_stat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wkid` int(11) DEFAULT NULL,
  `count` int(11) DEFAULT NULL,
  `operate` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tea`.`t_tea_wiki_stat`
--

/*!40000 ALTER TABLE `t_tea_wiki_stat` DISABLE KEYS */;
LOCK TABLES `t_tea_wiki_stat` WRITE;
INSERT INTO `tea`.`t_tea_wiki_stat` VALUES  (1,17,14,'pv'),
 (2,14,8,'pv'),
 (3,4,7,'pv'),
 (4,13,9,'pv'),
 (5,1,12,'pv'),
 ...
 (17,16,3,'pv');
UNLOCK TABLES;
/*!40000 ALTER TABLE `t_tea_wiki_stat` ENABLE KEYS */;
